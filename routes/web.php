...
use App\Http\Controllers\ReactController as ControllersReactController;
...
Route::middleware(['auth'])->group(function(){
    ...
    Route::post('/article/{post_id}',[BookmarkController::class,'bookmarkstore']);    

    Route::get('/bookmark/bookmarkindex',[BookmarkController::class,'bookmarkindex'])->name('bookmark.index');
