...
class TopController extends Controller
{
    ...
    public function top()
    {
        ...
        $posts = $this->post->orderBy('updated_at', 'desc')->where('publish_flg', true)->paginate(3);
    ...
    public function articleCategory($category_id)
    {
        ...
        $posts = $this->post->where('category_id', $category_id)->where('publish_flg', true)->orderBy('updated_at', 'desc')->paginate(3);
