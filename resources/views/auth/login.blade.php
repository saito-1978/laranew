<x-guest-layout>
<a class="flex items-center justify-center text-gray-600 font-bold mb-4 md:mb-0" href="{{ route('top') }}">
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="ml-2 text-sm text-gray-600 dark:text-gray-400">{{ __('ログイン状態を保持') }}</span>
            </label>
        </div>
